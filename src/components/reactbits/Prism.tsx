...
export const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const containerEl = container as HTMLDivElement & { __prismIO?: IntersectionObserver };
    ...
    return () => {
      ...
      if (suspendWhenOffscreen) {
        const io = containerEl.__prismIO;
        if (io) io.disconnect();
        delete containerEl.__prismIO;
      }
  ...
  return <div className={`prism-container ${className}`} style={style} ref={containerRef} />;
};
